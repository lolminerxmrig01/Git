...
class CrawlerService:
    def _start_crawling(self):
        ...
        while (main_category_repository.get_first_not_crawled(self.mysql_db_manager()) != None):
            ...
            self._crawl_sub_categories_general(offline_url, main_category)  # it will go to general
    ...
    def _crawl_sub_categories(self):
        index = 0
        # it's not empty and I'll crawl them deep if these is element not crawled
        while (sub_category_repository.get_first_not_crawled(self.mysql_db_manager()) != None):
    ...
    def _crawl_sub_categories_general(self, offline_url, main_category):
    ...
    def _crawl_days_general(self, offline_url, index, sub_category):
        ...
        if day_repository.is_empty(self.mysql_db_manager()) or day_repository.is_new_category(self.mysql_db_manager(),sub_category):
            ...
            month, year = day_repository.get_final_month(self.mysql_db_manager())
    ...
    def _store_days(self, offline_url, sub_category):
        ...
        for tr in b.find_all('tr'):
            ...
            for d in data:
                ...
                day = Day(sub_category_repository.get_id(self.mysql_db_manager(), sub_category), int(day_number),month, year,day_url)
    ...
    def _crawl_questions(self, offline_url,day):
        questions_list = []
        urls_list = []
        with open(offline_url, encoding="utf-8") as fp:
        ...
        for li in ul.findAll("a", href=True):
            ...
            if li.text.strip() != '' and self._search(urls_list, question_url) == False:
                ...
                # store Question
                question = Question(question_url, day_repository.get_id(self.mysql_db_manager(),day), question_text)
