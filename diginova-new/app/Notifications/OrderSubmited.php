...
class OrderSubmited extends KavenegarBaseNotification
{
    use Queueable;
    ...
    {
        $message = Setting::where('name', 'order_sms_text')->first()->value;
        $customer_name = customerFullName($withNumbr = false);

        $from = ['[customer]', '[order_code]'];
        $to = [$customer_name, $this->order_code];
        ...
        $message = $message 
            ...
            . "<br>" . "سفارش‌تان ثبت شد و در حال پردازش آن هستیم."
