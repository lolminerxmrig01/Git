...
return [
    ...
    */
    ...
    'version_installed' => env('SELF_UPDATER_VERSION_INSTALLED', '1.0'),
    ...
    */
    ...
    'repository_types' => [
        'github' => [
            'type'                 => 'github',
            'repository_vendor'    => env('SELF_UPDATER_REPO_VENDOR', 'vendor'),
            'repository_name'      => env('SELF_UPDATER_REPO_NAME', 'diginova'),
            'repository_url'       => '',
