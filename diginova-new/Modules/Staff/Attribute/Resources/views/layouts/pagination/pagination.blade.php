    ...
    @if ($paginator->onFirstPage())
        <li class="c-ui-paginator__control-item" aria-disabled="true" 
            ...
            <a class="pagination-link c-ui-paginator__control-prev
             c-ui-paginator__control-prev--disabled" aria-hidden="true" data-page=""></a>
        </li>
    @else
        <li class="c-ui-paginator__control-item">
            <a href="{{ $paginator->previousPageUrl() }}" 
                class="pagination-link c-ui-paginator__control-prev js-content-pager-item"
        ...
        @if (is_array($element))
            @foreach ($element as $page => $url)
                ...
                <li class="c-ui-paginator__control-item uk-active">
                    ...
                    c-ui-paginator__control-digit--current">{{ persianNum($page) }}</a>
                </li>
                @else
                <li class="c-ui-paginator__control-item">
                    <a href="{{ $url }}" data-page="" class="pagination-link c-ui-paginator__control-digit
    ...
    @else
        <li class="c-ui-paginator__control-item" aria-disabled="true" aria-label="@lang('pagination.next')">
            <a class="pagination-link c-ui-paginator__control-next
                c-ui-paginator__control-next--disabled" data-page=""  aria-hidden="true"></a>
        </li>
    @endif
</ul>
@endif
