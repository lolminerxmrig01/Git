                ...
                @foreach($values as $key => $item)
                   <tr name="row db-row" id="item-{{ $item->id }}" data-id="{{ $item->id }}" 
                    ...
                    <td class="c-ui-table__cell c-ui-table__cell--small-text" style="text-align: center; min-width: 200px;">
                        <span class="c-wallet__body-card-row-item c-ui--fit c-ui--initial">
                          <input type="text" class="c-content-input__origin c-content-input__origin menu_link"
                           name="intra_province" value="{{ $item->intra_province }}" dir="rtl" style="text-align: right;">
                        </span>
                    </td>
                    ...
                    <td class="c-ui-table__cell c-ui-table__cell--small-text" style="text-align: center; min-width: 200px;">
                        <span class="c-wallet__body-card-row-item c-ui--fit c-ui--initial">
                          <input type="text" class="c-content-input__origin c-content-input__origin menu_link" 
                          name="neighboring_provinces" value="{{ $item->neighboring_provinces }}" 
                    ...
                    <td class="c-ui-table__cell c-ui-table__cell--small-text" style="text-align: center; min-width: 200px;">
                        <span class="c-wallet__body-card-row-item c-ui--fit c-ui--initial">
                          <input type="text" class="c-content-input__origin c-content-input__origin menu_link"
                           name="extra_province" value="{{ $item->extra_province }}" dir="rtl" style="text-align: right;">
                        </span>
                    </td>
      ...
      <div class="c-card">
        <div class="edit-form-section c-card__footer c-card__footer--products">
          <div class="c-grid__col c-grid__col--gap-lg c-grid__col--flex-initial 
            c-grid__col--lg-6 c-grid__col--xs-gap" style="width: 40%; float: left; display: contents;">
            <a class="c-ui-btn c-ui-btn--next mr-a save-form" 
            style="margin-left: 68px;max-width: 100px;" data-value="all">ذخیره</a>
          </div>
        </div>
      </div>
    </div>
