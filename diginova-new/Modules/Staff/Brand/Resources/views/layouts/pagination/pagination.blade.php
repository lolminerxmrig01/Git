...
<ul class="c-ui-paginator__control">
  ...
  @else
    <li class="c-ui-paginator__control-item">
      <a href="{{ $paginator->previousPageUrl() }}" class="pagination-link c-ui-paginator__control-prev js-content-pager-item" aria-hidden="true" aria-label="@lang('pagination.previous')"></a>
    </li>
  @endif
  ...
  @if ($paginator->hasMorePages())
    <li class="c-ui-paginator__control-item">
      <a class="pagination-link c-ui-paginator__control-next js-content-pager-item" href="{{ $paginator->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')"></a>
    </li>
  @else
